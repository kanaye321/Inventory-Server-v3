    ...
    return (
      <div className="space-y-2">
        <div className="flex justify-between text-sm">
          ...
          <span className="text-gray-600 dark:text-gray-400">{value} / {total} ({Math.round(percentage)}%)</span>
        </div>
            ...
            <CardContent className="p-6">
                    ...
                    <CardContent className="p-6 space-y-4">
                      ...
                      <div className="pt-4 border-t">
                        <div className="text-center">
                          <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Overall Health Score</p>
              ...
              <TabsContent value="laptops" className="space-y-4 mt-0">
                ...
                <Card className="border-2 border-blue-100">
                  ...
                  <CardContent className="p-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'laptop' })} className="bg-white dark:bg-gray-800 p-4 rounded-lg border-2 border-gray-200 dark:border-gray-700 hover:border-blue-300 transition-all cursor-pointer">
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Total Laptops</p>
                        <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">{laptopStats.total}</p>
                      </div>
              ...
              <TabsContent value="desktops" className="space-y-4 mt-0">
                ...
                <Card className="border-2 border-purple-100 dark:border-purple-900">
                  ...
                  <CardContent className="p-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div onClick={() => navigateWithFilters({ categoryFilter: 'desktop' })} className="bg-white dark:bg-gray-800 p-4 rounded-lg border-2 border-gray-200 dark:border-gray-700 hover:border-purple-300 transition-all cursor-pointer">
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Total Desktops</p>
                        <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">{desktopStats.total}</p>
                      </div>
                    ...
                    <div className="space-y-4">
                      {Object.entries(departmentData)
                        ...
                        .map(([dept, data]: [any, any], index: number) => {
                          ...
                          return (
                            <div key={dept} onClick={() => navigateWithFilters({ departmentFilter: dept, statusFilter: 'Deployed' })} className="bg-white dark:bg-gray-800 p-5 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-orange-300 hover:shadow-md transition-all cursor-pointer">
                              <div className="flex items-center justify-between mb-3">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <h4 className="font-semibold text-gray-900 dark:text-gray-100">{dept}</h4>
              ...
              <TabsContent value="daterange" className="space-y-6 mt-0">
                <div className="flex flex-col gap-4 mb-4">
                  ...
                  <div className="flex flex-wrap gap-2 items-center">
                    <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Additional Filters:</span>
