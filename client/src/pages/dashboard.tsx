              ...
              <div className="space-y-4">
                {criticalActivities.length > 0 ? (
                  criticalActivities.map((activity: any, index: number) => {
                    ...
                    return (
                      <div key={index} className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 transition-colors">
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              <div className="text-center cursor-pointer transition-transform hover:scale-105 p-4 rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700" onClick={() => window.location.href = '/vm-inventory'}>
              ...
              <div className="text-center cursor-pointer transition-transform hover:scale-105 p-4 rounded-lg bg-green-50 hover:bg-green-100 dark:bg-green-950 dark:hover:bg-green-900" onClick={() => window.location.href = '/vm-inventory?statusFilter=Active'}>
              ...
              <div className="text-center cursor-pointer transition-transform hover:scale-105 p-4 rounded-lg bg-orange-50 hover:bg-orange-100 dark:bg-orange-950 dark:hover:bg-orange-900" onClick={() => window.location.href = '/vm-inventory?statusFilter=Overdue - Notified'}>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Overdue - Notified</p>
              </div>

              <div className="text-center cursor-pointer transition-transform hover:scale-105 p-4 rounded-lg bg-red-50 hover:bg-red-100 dark:bg-red-950 dark:hover:bg-red-900" onClick={() => window.location.href = '/vm-inventory?statusFilter=Overdue - Not Notified'}>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Overdue - Not Notified</p>
              </div>

              <div className="text-center cursor-pointer transition-transform hover:scale-105 p-4 rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700" onClick={() => window.location.href = '/vm-inventory?statusFilter=Decommissioned'}>
                <div className="w-12 h-12 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Database className="h-6 w-6 text-gray-600 dark:text-gray-400" />
                </div>
                <div className="text-2xl font-bold text-gray-600 dark:text-gray-400 mb-1 hover:underline">{processedVMs.filter(vm => vm.vmStatus === "Decommissioned").length}</div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Decommissioned</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
              <div className="text-center cursor-pointer transition-transform hover:scale-105 p-4 rounded-lg bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700" onClick={() => window.location.href = '/iam-accounts'}>
                <div className="w-12 h-12 bg-blue-100 dark:bg-blue-950 rounded-full flex items-center justify-center mx-auto mb-3">
              ...
              <div className="text-center cursor-pointer transition-transform hover:scale-105 p-4 rounded-lg bg-green-50 hover:bg-green-100 dark:bg-green-950 dark:hover:bg-green-900" onClick={() => window.location.href = '/iam-accounts?statusFilter=active'}>
                <div className="w-12 h-12 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mx-auto mb-3">
                  <CheckCircle className="h-6 w-6 text-green-600" />
                </div>
              ...
              <div className="text-center cursor-pointer transition-transform hover:scale-105 p-4 rounded-lg bg-blue-50 hover:bg-blue-100 dark:bg-blue-950 dark:hover:bg-blue-900" onClick={() => window.location.href = '/iam-accounts?statusFilter=extended'}>
              ...
              <div className="text-center cursor-pointer transition-transform hover:scale-105 p-4 rounded-lg bg-red-50 hover:bg-red-100 dark:bg-red-950 dark:hover:bg-red-900" onClick={() => window.location.href = '/iam-accounts?statusFilter=expired_notified'}>
                <div className="w-12 h-12 bg-red-100 dark:bg-red-900 rounded-full flex items-center justify-center mx-auto mb-3">
                  <AlertTriangle className="h-6 w-6 text-red-600" />
                </div>
                <div className="text-2xl font-bold text-red-600 mb-1 hover:underline">{expiredNotifiedIamAccounts}</div>
                <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Expired - Notified</p>
              </div>

              <div className="text-center cursor-pointer transition-transform hover:scale-105 p-4 rounded-lg bg-yellow-50 hover:bg-yellow-100 dark:bg-yellow-950 dark:hover:bg-yellow-900" onClick={() => window.location.href = '/iam-accounts?statusFilter=expired_not_notified'}>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Expired - Not Notified</p>
              </div>

              <div className="text-center cursor-pointer transition-transform hover:scale-105 p-4 rounded-lg bg-orange-50 hover:bg-orange-100 dark:bg-orange-950 dark:hover:bg-orange-900" onClick={() => window.location.href = '/iam-accounts?statusFilter=access_removed'}>
                <div className="w-12 h-12 bg-orange-100 dark:bg-orange-900 rounded-full flex items-center justify-center mx-auto mb-3">
                  <XCircle className="h-6 w-6 text-orange-600" />
                </div>
                <div className="text-2xl font-bold text-orange-600 mb-1 hover:underline">{accessRemovedIamAccounts}</div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Access Removed</p>
              </div>
            </div>
          </CardContent>
        </Card>
