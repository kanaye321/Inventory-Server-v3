      ...
      <div className="space-y-8 p-6 animate-in fade-in-0 duration-700">
        ...
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 border-0 shadow-xl">
                <CardHeader className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border-b border-blue-100 dark:border-blue-900">
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center p-4 bg-green-50 dark:bg-green-950 rounded-lg">
                      ...
                      <Badge variant="outline" className="text-lg px-3 py-1 border-green-500 text-green-700 dark:text-green-400">{laptopStats.onHand}</Badge>
                    </div>
                    <div className="flex justify-between items-center p-4 bg-blue-50 dark:bg-blue-950 rounded-lg">
                      ...
                      <Badge variant="outline" className="text-lg px-3 py-1 border-blue-500 text-blue-700 dark:text-blue-400">{laptopStats.deployed}</Badge>
                    </div>
                    <div className="flex justify-between items-center p-4 bg-yellow-50 dark:bg-yellow-950 rounded-lg">
                      <span className="font-medium">Pending for Deployment:</span>
                      <Badge variant="outline" className="text-lg px-3 py-1 border-yellow-500 text-yellow-700 dark:text-yellow-400">{laptopStats.pendingDeployment}</Badge>
                    </div>
                    <div className="flex justify-between items-center p-4 bg-emerald-50 dark:bg-emerald-950 rounded-lg">
                      ...
                      <Badge variant="outline" className="text-lg px-3 py-1 border-emerald-500 text-emerald-700 dark:text-emerald-400">{laptopStats.goodCondition}</Badge>
                    </div>
                    <div className="flex justify-between items-center p-4 bg-red-50 dark:bg-red-950 rounded-lg">
                      ...
                      <Badge variant="outline" className="text-lg px-3 py-1 border-red-500 text-red-700 dark:text-red-400">{laptopStats.badCondition}</Badge>
                    </div>
                      ...
                      <Badge variant="outline" className="text-lg px-3 py-1 border-orange-500 text-orange-700 dark:text-orange-400">{laptopStats.reserved}</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              {/* Desktop Summary */}
              <Card className="backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 border-0 shadow-xl">
                <CardHeader className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border-b border-purple-100 dark:border-purple-900">
                  <CardTitle className="text-xl font-bold text-slate-800 dark:text-slate-100 flex items-center gap-3">
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center p-4 bg-green-50 dark:bg-green-950 rounded-lg">
                      ...
                      <Badge variant="outline" className="text-lg px-3 py-1 border-green-500 text-green-700 dark:text-green-400">{desktopStats.onHand}</Badge>
                    </div>
                    <div className="flex justify-between items-center p-4 bg-blue-50 dark:bg-blue-950 rounded-lg">
                      <span className="font-medium">Deployed Desktops:</span>
                      <Badge variant="outline" className="text-lg px-3 py-1 border-blue-500 text-blue-700 dark:text-blue-400">{desktopStats.deployed}</Badge>
                    </div>
                    <div className="flex justify-between items-center p-4 bg-yellow-50 dark:bg-yellow-950 rounded-lg">
                      <span className="font-medium">Pending for Deployment:</span>
                      <Badge variant="outline" className="text-lg px-3 py-1 border-yellow-500 text-yellow-700 dark:text-yellow-400">{desktopStats.pendingDeployment}</Badge>
                    </div>
                    <div className="flex justify-between items-center p-4 bg-emerald-50 dark:bg-emerald-950 rounded-lg">
                      <span className="font-medium">Good Condition:</span>
                      <Badge variant="outline" className="text-lg px-3 py-1 border-emerald-500 text-emerald-700 dark:text-emerald-400">{desktopStats.goodCondition}</Badge>
                    </div>
                    <div className="flex justify-between items-center p-4 bg-red-50 dark:bg-red-950 rounded-lg">
                      <span className="font-medium">Bad Condition:</span>
                      <Badge variant="outline" className="text-lg px-3 py-1 border-red-500 text-red-700 dark:text-red-400">{desktopStats.badCondition}</Badge>
                    </div>
                                        <div className="flex justify-between items-center p-4 bg-orange-50 dark:bg-orange-950 rounded-lg">
                      <span className="font-medium">Reserved Desktops:</span>
                      <Badge variant="outline" className="text-lg px-3 py-1 border-orange-500 text-orange-700 dark:text-orange-400">{desktopStats.reserved}</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="departments" className="space-y-6">
            ...
            <Card className="backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 border-0 shadow-xl">
              <CardHeader className="bg-gradient-to-r from-green-500/10 to-teal-500/10 border-b border-green-100 dark:border-green-900">
                <CardTitle className="text-xl font-bold text-slate-800 dark:text-slate-100 flex items-center gap-3">
          ...
          <TabsContent value="age-analysis" className="space-y-6">
            ...
            <Card className="backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 border-0 shadow-xl">
              <CardHeader className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border-b border-orange-100 dark:border-orange-900">
                <CardTitle className="text-xl font-bold text-slate-800 dark:text-slate-100 flex items-center gap-3">
              ...
              <CardContent className="p-6">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg text-center">
                    ...
                    <div className="text-sm text-slate-600 dark:text-slate-400">1 Year Old</div>
                  </div>
                  <div className="p-4 bg-green-50 dark:bg-green-950 rounded-lg text-center">
                    <div className="text-2xl font-bold text-green-600">{laptopAgeStats.twoYears}</div>
                    <div className="text-sm text-slate-600 dark:text-slate-400">2 Years Old</div>
                  </div>
                  <div className="p-4 bg-yellow-50 dark:bg-yellow-950 rounded-lg text-center">
                    ...
                    <div className="text-sm text-slate-600 dark:text-slate-400">3 Years Old</div>
                  </div>
                  <div className="p-4 bg-orange-50 dark:bg-orange-950 rounded-lg text-center">
                    ...
                    <div className="text-sm text-slate-600 dark:text-slate-400">4 Years Old</div>
                  </div>
                  <div className="p-4 bg-red-50 dark:bg-red-950 rounded-lg text-center">
                    <div className="text-2xl font-bold text-red-600">{laptopAgeStats.fiveYears}</div>
                    <div className="text-sm text-slate-600 dark:text-slate-400">5 Years Old</div>
                  </div>
          ...
          <TabsContent value="user-analysis" className="space-y-6">
            ...
            <Card className="backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 border-0 shadow-xl">
              <CardHeader className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border-b border-indigo-100 dark:border-indigo-900">
                <CardTitle className="text-xl font-bold text-slate-800 dark:text-slate-100 flex items-center gap-3">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  <div className="p-4 bg-red-50 dark:bg-red-950 rounded-lg text-center">
                    ...
                    <div className="text-sm text-slate-600 dark:text-slate-400">Users with only 5+ year old laptops</div>
                  </div>
              ...
              <div className="lg:col-span-1 space-y-4">
                ...
                <div className="space-y-3 pt-4 border-t">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between items-center p-2 bg-slate-50 dark:bg-slate-800 rounded">
                      <span className="text-slate-600 dark:text-slate-400">Report Type:</span>
                      <Badge variant="outline" className="font-semibold">
